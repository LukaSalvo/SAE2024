...
public class LabyDessin implements DessinJeu {
    ...
    public void dessinerJeu(Jeu jeu, Canvas canvas) {
        ...
        Labyrinthe l = game.getLabyrinthe();
        boolean[][] murs = l.getMurs();
        ...
        int x = LabyJeu.WIDTH / murs.length;
        int y = LabyJeu.HEIGHT / murs[0].length;

        // Dessin du labyrinthe
        dessinerLabyrinthe(gc, murs, x, y);
        //Dessin cases pièges
        dessinerCasesPieges(gc, l.getCasesPieges(), x, y);
        // Dessin du personnage
        dessinerPersonnage(gc, l.getPj(), x, y);
        // Dessin des monstres
        dessinerMonstres(gc, l.getListMonstre(), x, y);
